...
{
    /// <inheritdoc />
    public partial class Migraciok : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedBy = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    AssignedTo = table.Column<string>(type: "varchar(255)", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    TaskLabelId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_KanbanTasks", x => x.TaskId);
                    table.ForeignKey(
                        name: "FK_KanbanTasks_AspNetUsers_AssignedTo",
                        column: x => x.AssignedTo,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_KanbanTasks_AspNetUsers_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_KanbanTasks_Lists_ListId",
                        column: x => x.ListId,
                        principalTable: "Lists",
                        principalColumn: "ListId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_KanbanTasks_TaskLabels_TaskLabelId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_KanbanTasks_AssignedTo",
                table: "KanbanTasks",
                column: "AssignedTo");

            migrationBuilder.CreateIndex(
                name: "IX_KanbanTasks_CreatedBy",
                table: "KanbanTasks",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_KanbanTasks_ListId",
                table: "KanbanTasks",
                column: "ListId");

            migrationBuilder.CreateIndex(
                name: "IX_KanbanTasks_TaskLabelId",
                table: "KanbanTasks",
                column: "TaskLabelId",
                unique: true);
